...
const Tasks = () => {
  const { tasks, categories, apiError, addTask, updateTask, deleteTask, toggleTask, duplicateTask } =
    ...
    <DashboardLayout>
      <div className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-slate-500'>Add, edit, duplicate, pin, filter, and complete study tasks.</p>
        </div>
        ...
        <div className='grid gap-6 xl:grid-cols-[380px_1fr]'>
          <Card>
            <h2 className='text-xl font-bold text-slate-950'>{editingTask ? 'Edit task' : 'Add task'}</h2>
            <div className='mt-5'>
              <TaskForm
